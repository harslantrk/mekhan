			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
					<div class="row">
						...
						<?php if(isset($bilgiler["aciklama"])){ ?>
						<div class="col-md-6">
							<h4>Açıklama</h4>
				...
				<div class="col-md-offset-1 col-md-10">
					<div class="col-md-12">
						<div class="row">
							...
							<?php } ?>
							<form action="<?php echo base_url("siparis/siparis/".$this->uri->segment(3,0)."/".$bilgiler["id"]); ?>" method="post">
								...
								$ozellik = json_decode($bilgiler["ozellik"], true);
								foreach($ozellik as $key => $ozel){ ?>
									<input type="hidden" name="bilgiler[]" value="<?php echo $key." :".$ozel; ?>" />
								<?php } ?>
	...
	<script>
		$(function(){
			$("#il").change(function(){	
				...
				var url = "<?php echo base_url("siparis/urunsiparis"); ?>";
				 $.ajax({
				   type: "POST",
				   url: url,
				   data: {il : il}, 
