	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-md-3 margin-top">
				<a href="<?php echo base_url("telefonsat/teknesecdegisim/".$marka["seo_url"]);?>" title="">
				<img src="<?php echo $marka["fotograf"]; ?>" alt="" class="img-responsive urunfoto"/></a>
				<a href="<?php echo base_url("telefonsat/teknesecdegisim/".$marka["seo_url"]);?>" title="" class="btn btn-default markabuton"><?php echo $marka["title"]; ?></a> 
			</div>
			<?php } ?>
		</div>
	</div>
