	<div class="container" >
		<div class="row">
			...
			<div class="col-md-3 margin-top">
				<a href="<?php echo base_url("telefonsat/bilgilerdegisim/".seo($model["title"])."/".$model["id"]);?>" title="">
				<img src="<?php echo $model["fotograf"]?>" alt="" class="img-responsive urunfoto"/></a>
				<a href="<?php echo base_url("telefonsat/bilgilerdegisim/".seo($model["title"])."/".$model["id"]);?>" class="btn btn-default markabuton" ><?php echo $model["title"]?></a> 
			</div>
			<?php } ?>
