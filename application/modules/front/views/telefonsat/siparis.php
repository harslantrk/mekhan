				...
				<div class="col-md-offset-1 col-md-10">
					<div class="col-md-12">
						<div class="row">
							...
							<?php } ?>
							<form action="<?php echo base_url("telefonsatsiparis/telefonsatsiparis/".$this->uri->segment(3,0)."/".$bilgiler["id"]); ?>" method="post">
	...
	<script>
		$(function(){
			$("#il").change(function(){	
				...
				var url = "<?php echo base_url("telefonsatsiparis/telefonsaturunsiparis"); ?>";
				 $.ajax({
				   type: "POST",
				   url: url,
				   data: {il : il}, 
