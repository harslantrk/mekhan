...
class Login_model extends CI_Model {
	...
	public function login_up()
	{
		...
		$query=$this->db->query("select * from li_users where ( username='".$user."' or  email='".$user."' ) and password='".$pass."' and status=1");
	...
	public function facebook_login_up($userId)
	{

		
		$query=$this->db->query("select * from li_users where facebook_id='".$userId."' and status=1");
	...
	public function cookie_login_up()
	{
		...
		$query=$this->db->query("select * from li_users where id='".get_cookie('id')."' and status=1");
