                ...
                <?php foreach ($list as $li): ?>
                        ...
                        <form  id="validate-edit" method="POST" class="form-horizontal">
                            <input type="hidden" name="id" value="<?= $li->id ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="text" name="title" value="<?php if ($this->input->post()) {
                    ...
                    echo $li->title;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="text" name="link" value="<?php if ($this->input->post()) {
                    echo set_value('link');
                } else {
                    echo $li->link;
                } ?>" class="form-control required"></div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Fotoğraf (67x343)</label>
                                    <div class="col-sm-10" id="blueimp">


                                        <div id="img_scheme">
                                            <div class="file-box">
                                                <input type="hidden" name="fotograf" value="<?php echo $li->fotograf; ?>" class="form-control">
                                                    <div class="file">
                                                        <span class="corner"></span>
                                                        <div class="image">
                                                            <a href="/uploads/no-img.jpg">
                                                                <img alt="image" class="img-responsive" src="<?php echo $li->fotograf; ?>"></a>
                                                        </div>
                                                        <div class="file-name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="number" name="priority" value="<?php if ($this->input->post()) {
                    echo set_value('priority');
                } else {
                    echo $li->priority;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input name="status" value="1" type="checkbox" class="js-switch" <?php if ($this->input->post('status')) {
                    echo 'checked';
                } else if ($li->status) {
                    echo 'checked';
                } ?> /></div>
