        	...
        	<div class="ibox float-e-margins">
	            <div class="ibox-title">
	                ...
	                <div class="ibox-tools">
	                    <a href="<?=base_url()?>admin/slider/insert_slider" class="btn btn-primary" style="margin: -10px -10px 0px 0px;"> <i class="fa fa-plus"></i> Mekan Ekle</a>
	                </div>
	            </div>
			            ...
			            <tbody>
			            	<?php foreach($slider as  $s):?>
					            <tr class="gradeX">
					                ...
					                <td>
					                	<button rel="tooltip" title="Düzenle" onclick="location='<?=base_url()?>admin/slider/update_slider/<?=$s->id?>'" class="btn btn-primary btn-circle btn-outline " type="button"><i class="fa fa-pencil"></i></button>
					                	<button rel="tooltip" title="Aktif/Pasif" ajax-handler="slider_status" class="toggle-statu btn btn-default btn-circle btn-outline" type="button" ><i class="fa fa-<?php if($s->status==1){echo "check";}else{echo "uncheck";}?>"></i></button>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content animated flipInY">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="delete-item" delete-handler="slider_delete" delete-id="" data-dismiss="modal"> <i class="fa fa-trash"></i> Sil</button>
            </div>
        </div>
    </div>
</div>