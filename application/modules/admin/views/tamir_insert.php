	                ...
	                <form  id="validate-add" method="POST" class="form-horizontal">
	                    ...
	                    <div class="hr-line-dashed"></div>
						 ...
						 <div class="form-group">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-2"> Kırık Ekran:		<input type="number" name="kirikekran" value="" class="form-control"></div>
									<div class="col-sm-2"> Sıvı Teması:		<input type="number" name="sivitemasi" value="" class="form-control"></div>
									<div class="col-sm-2"> Şarj Sorunu:		<input type="number" name="sarjsorunu" value="" class="form-control"></div>
									<div class="col-sm-2"> Ses Sorunu:		<input type="number" name="sessorunu" value="" class="form-control"></div>
									<div class="col-sm-2"> Pil Sorunu:		<input type="number" name="pilsorunu" value="" class="form-control"></div>
									<div class="col-sm-2"> Tuş Sorunu:		<input type="number" name="tussorunu" value="" class="form-control"></div>
									<div class="col-sm-2"> Kamera Sorunu:	<input type="number" name="kamerasorunu" value="" class="form-control"></div>
									<div class="col-sm-2"> Tamir Süre(6saat):	<input type="number" name="tamirsure" value="" class="form-control"></div>
									<div class="col-sm-2"> Yedek Telefon:	<input type="number" name="yedektelefon" value="" class="form-control"></div>
