	            ...
	            <div class="ibox-content">
	                <form  id="validate-add" method="POST" class="form-horizontal" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-10"><input type="text" name="baslik" value="" class="form-control required"></div>
	                    </div>
	                    ...
	                    <div class="hr-line-dashed"></div>
						 ...
						 <div class="form-group">
	                        ...
	                        <div class="col-sm-10"><textarea name="icerik" class="form-control" rows="10"></textarea></div>
	                    </div>
						<div class="hr-line-dashed"></div>

						<div class="form-group">
	                    	<label class="col-sm-2 control-label">Tarih</label>
	                        <div class="col-sm-10"><input type="date" name="tarih" value="" class="form-control"></div>
	                    </div>
	                    <div class="form-group">
