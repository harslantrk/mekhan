	                   ...
	                   <!-- <div class="form-group">
	                    ...
	                    <div class="hr-line-dashed"></div>
						 ...
						 <div class="form-group">
	                        ...
	                        <div class="col-sm-10"><textarea name="content" class="form-control" rows="10"><?php echo $content; ?></textarea></div>
	                    </div>
	                     <div class="form-group">
	                    	<label class="col-sm-2 control-label">Tarih</label>
	                        <div class="col-sm-10"><input type="date" name="date" value="<?php echo $date; ?>" class="form-control"></div>
	                    </div>
						<div class="hr-line-dashed"></div>
