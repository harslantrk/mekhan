...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
		...
		'tr':
		{
			...
			'next-year':'Gelecek il',
			'less-than' : 'Tarih aralığı %d günden ileri olmamalıdır',
			'more-than' : 'Tarih aralığı %d günden geri olmamalıdır',
			'default-more' : '%d günden ileri bir tarih seçin',
			'default-single' : 'Tarih seçin',
			'default-less' : '%d günden geri bir tarih seçin',
			'default-range' : '%d ve %d gün aralığında tarihlər seçin',
